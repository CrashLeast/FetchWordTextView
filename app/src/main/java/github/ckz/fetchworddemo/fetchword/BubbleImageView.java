...
/**
 * Created by chenkuizhi on 2018/5/12.
 */

public class BubbleImageView extends android.support.v7.widget.AppCompatImageView {

    private static final int DEFAULT_BODER_WIDTH=1;//dp
    private static final int DEFAULT_ARROW_WIDTH=5;//dp
    private static final int DEFAULT_ARROW_HEIGHT=5;//dp
    private static final int DEFAULT_ARROW_ANGLE=5;//dp
    private static final int DEFAULT_ARROW_POSITION=5;//dp
    ...
    private void initView() {
        ...
        mBoderWidth =(int) (DEFAULT_BODER_WIDTH * metrics.density + 0.5f);
        mArrowWidth =(int) (DEFAULT_ARROW_WIDTH * metrics.density + 0.5f);
        mArrowHeight =(int) (DEFAULT_ARROW_HEIGHT * metrics.density + 0.5f);
        mAngle =(int) (DEFAULT_ARROW_ANGLE * metrics.density + 0.5f);
        mArrowPosition =(int) (DEFAULT_ARROW_POSITION * metrics.density + 0.5f);
